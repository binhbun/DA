 ...
 thu nhập nếu khách truy cập bỏ qua trang quảng cáo" />
  ...
  <style>
    ...
    .login-page {
      ...
      /* Khoảng cách phía trên, có thể điều chỉnh */
    }
  </style>
</head>
...
<body class="bg-gray-50">
  ...
  <main>
    <section class="login-page">
      <div class="form">
        <h2 style="text-align: center;  color: white; font-weight: 700;">Quên mật khẩu</h2>

        @if (session('status'))
        <div class="alert alert-success" style="color: white;">{{ session('status') }}</div>
        @endif
        <form action="{{ route('password.email') }}" method="POST">
          ...
          <div class="inputForm">
            ...
            <input for="email" name="email" type="email" placeholder="Enter your Email" class="input" required autofocus />
          </div>
          @if ($errors->any())
          ...
          @endif
          <button type="submit" style=" background: linear-gradient(45deg, yellow, red);" class="button-submit">Nhận mật khẩu</button>
          <br>
        </form>


        <a href="{{route('login')}}">
          <button class="button-submit"> Quay lại Đăng nhập</button> </a>
    </section>
  </main>
