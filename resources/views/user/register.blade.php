...
<head>
  ...
  <meta name="description" content="Bắt đầu kiếm tiền từ các liên kết trên trang web hoặc phương tiện truyền thông xã hội của bạn, Đăng ký miễn phí và dễ dàng! Bạn có thể bắt đầu
 tạo các liên kết ngắn và bắt đầu chia sẻ các liên kết ngắn đó. nếu ai đó truy cập vào liên kết ngắn mà bạn tạo, bạn sẽ kiếm được
 thu nhập nếu khách truy cập bỏ qua trang quảng cáo" />
  ...
  <main>
    <section class="login-page">
      ...
      <div class="form1">
        ...
        <h2 style="text-align: center;  color: white; font-weight: 700;">ĐÃ CÓ TÀI KHOẢN?</h2>

        <p class="p">Đăng nhập ngay để nhận ưu đãi và dễ dàng quản lý các dịch vụ đã đăng ký tại BBMKTS</p>
        <a href="/login" class="btn_google1">
      ...
      <div class="form">
        <h2 style="text-align: center;  color: white; font-weight: 700;">Đăng ký</h2>
        <form method="POST" action="{{ route('register') }}" id="form-register">
          @csrf

          <div class="flex space-x-2 border-[3px] border-purple-300 rounded-xl select-none ">
            <label class="radio flex flex-grow items-center justify-center rounded-lg p-1 cursor-pointer">
              <input type="radio" name="role_active" value="2" class="peer hidden" checked="" />
              <span class="tracking-widest peer-checked:bg-gradient-to-r peer-checked:from-[blueviolet] peer-checked:to-[violet] peer-checked:text-white text-gray-700 p-2 rounded-lg transition duration-150 ease-in-out">Publishers (Người kiếm tiền)</span>
            </label>
          </div>
          ...
          <div class="inputForm">
            <svg xmlns="http://www.w3.org/2000/svg" width="15" viewBox="0 0 32 32" height="15">
              <g data-name="Layer 3" id="Layer_3">
                <path d="m30.853 13.87a15 15 0 0 0 -29.729 4.082 15.1 15.1 0 0 0 12.876 12.918 15.6 15.6 0 0 0 2.016.13 14.85 14.85 0 0 0 7.715-2.145 1 1 0 1 0 -1.031-1.711 13.007 13.007 0 1 1 5.458-6.529 2.149 2.149 0 0 1 -4.158-.759v-10.856a1 1 0 0 0 -2 0v1.726a8 8 0 1 0 .2 10.325 4.135 4.135 0 0 0 7.83.274 15.2 15.2 0 0 0 .823-7.455zm-14.853 8.13a6 6 0 1 1 6-6 6.006 6.006 0 0 1 -6 6z"></path>
              </g>
            </svg>
            <input id="name" name="name" type="text" placeholder="Nhập Nickname" class="input" value="{{ old('name') }}" type="text" required autofocus />
            @if ($errors->has('name'))
          ...
          <div class="inputForm">
            ...
            <input id="hoten" name="hoten" value="{{ old('hoten') }}" type="text" placeholder="Nhập họ tên" class="input" required autofocus />
            @if ($errors->has('hoten'))
            <span class="invalid-feedback">
          ...
          <div class="inputForm">
            <svg xmlns="http://www.w3.org/2000/svg" width="15" viewBox="-64 0 512 512" height="15">
              <path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0"></path>
              <path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0"></path>
            </svg>
            <input id="password" type="password" placeholder="Nhập mật khẩu" class="input" name="password" required />
          ...
          <div class="inputForm">
            ...
            <input placeholder="Nhập lại mật khẩu" id="password-confirm" type="password" class="input" name="password_confirmation" required />
            <span class="password-toggle" onclick="togglePassword(this, 'password_confirmation')">👁️</span>

          </div>
          @if ($errors->any())
          <div class="alert alert-danger" style="color: white; font-weight: 700">
            <ul>
    ...
    <section class="login-page-min">
      <div class="form-min">
        <h2 style="text-align: center;  color: white; font-weight: 700;">Đăng ký</h2>
        <form method="POST" action="{{ route('register') }}" id="form-register1">
          @csrf
          ...
          <div class="inputForm">
            ...
            <input id="name1" name="name" type="text" placeholder="Nhập Nickname" class="input" value="{{ old('name') }}" type="text" required autofocus />
            @if ($errors->has('name'))
            <span class="invalid-feedback">
              <strong>{{ $errors->first('name') }}</strong>
            </span>
          ...
          <div class="inputForm">
            ...
            <input id="hoten1" name="hoten" value="{{ old('hoten') }}" type="text" placeholder="Nhập họ tên" class="input" required autofocus />
            @if ($errors->has('hoten'))
            <span class="invalid-feedback">
              <strong>{{ $errors->first('hoten') }}</strong>
            </span>
          ...
          <div class="inputForm">
            ...
            <input id="password1" type="password" placeholder="Nhập mật khẩu" class="input" name="password" required />
          ...
          <div class="flex-column">
            <label for="password_confirm1">Confirm Password </label>
          </div>
          <div class="inputForm">
            <svg xmlns="http://www.w3.org/2000/svg" width="15" viewBox="-64 0 512 512" height="15">
              <path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0"></path>
            ...
            <input placeholder="Nhập lại mật khẩu" id="password_confirm1" type="password" class="input" name="password_confirmation" required />
            <span class="password-toggle" onclick="togglePassword1(this, 'password_confirm1')">👁️</span>
        ...
        <p class="p">Đã có tài khoản?</p><a href="/login" class="btn_google1">
          <button class="signupBtn">
            Đăng nhập
          </button></a>
        <p class="p line">Hoặc</p>
