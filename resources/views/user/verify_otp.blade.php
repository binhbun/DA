...
<body class="bg-gray-50">
  ...
  <main>
    <section class="login-page">
      <div class="form">
        <h2 style="text-align: center;  color: white; font-weight: 700;">Xác thực tài khoản</h2>
        ...
        <form action="{{ route('verify.otp') }}" method="POST">
          ...
          <div class="inputForm">
            <input type="text" name="otp" required for="email" placeholder="Enter your OTP" class="input" required autofocus>
          </div>
          @if ($errors->any())
          ...
          @endif
          <button type="submit" style=" background: linear-gradient(45deg, yellow, red);" class="button-submit">Xác nhận</button>
        </form>
        <button id="resend-otp" onclick="resendOtp()" class="button-submit" style=" background: linear-gradient(45deg, yellow, red);" class="button-submit">Gửi lại mã OTP</button>
  ...
  <script>
    ...
    function startCountdown() {
      const resendButton = document.getElementById('resend-otp');
      resendButton.textContent = `Gửi lại mã OTP (${countdown}s)`;
