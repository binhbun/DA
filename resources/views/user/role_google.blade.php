...
<body class="bg-gray-50">
  ...
  <main>
    <section class="login-page">
      <div class="form">
        <h2 style="text-align: center;  color: white; font-weight: 700;">Hoàn tất thông tin đăng ký</h2>
        <form action="{{ route('register.google') }}" method="POST">
          @csrf
          <input type="hidden" name="hoten" value="{{ $hoten }}">
          <input type="hidden" name="name" value="{{ $name }}">
          <input type="hidden" name="email" value="{{ $email }}">
          <h3 style="text-align: center;  color: white; font-weight: 700;">Chọn vai trò</h3>

          <div class="check_role">
            <div class="custom-radio-group">
              <input type="radio" id="radio-1" name="role_active" value="2" checked>
              <label class="radio-label" for="radio-1">
                <div class="radio-circle"></div>
                <span class="radio-text">Publishers (Người kiếm tiền)</span>
              </label>
              <input type="radio" id="radio-2" name="role_active" value="3">
    ...
    <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:-10">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-5">
        <div class="lg:col-span-2">
          ...
          <p class="my-4 font-light text-gray-500 dark:text-gray-400">Trao quyền cho người sáng tạo kỹ thuật số kể từ
            năm 2020.
            Hợp lý hóa các liên kết của bạn và kiếm tiền từ sự hiện diện trực tuyến của bạn với chúng tôi. Đáng tin cậy,
            hiệu quả và
      ...
      <span class="block text-sm text-center text-gray-500 dark:text-gray-400"><strong>Copyright &copy; 2020 -
          {{date('Y')}} <a href="https://www.facebook.com/binhbun02" target="_blank">Bình Bun</a>.</strong> All rights
        reserved.</span>
    </div>
  </footer>
