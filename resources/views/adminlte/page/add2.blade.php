                    ...
                    <div class="card">
                        <div class="card-header card-text">
                            ...
                            <select id="create-page" namme="type3">
                                <option value="create-page-1"> Lever 1: User Google tìm kiếm (Hiện nút lấy mã) </option>
...
{{--                                </div>--}}
                                ...
                                <label><strong>Ảnh minh họa bài viết chạy traffic (Chèn link *) =>>> </strong> <strong> 
                                        <button type="button" class="btn btn-primary btn-xs" style="white-space:nowrap; border-radius: 10px; padding: 5px; margin: 5px; text-align: center;" onclick="window.open('{{ route('upanh') }}', '_blank')">
                                            <strong class="card-text">Bấm vào đây để up ảnh lấy link!</strong></button>
                                     </label>
