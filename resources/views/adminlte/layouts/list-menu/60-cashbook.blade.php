...
<li >
        <a href="{{route('admin.get-all-payment')}}">
        <!-- <i class="fa fa-money"></i> -->
        <img src="https://i.imgur.com/APi3LeR.png" alt="Thống kê" style="width: 20px; height: 20px;">
            <span class="title__v1">Payment user</span>
    ...
    <!-- <li class="treeview {{ (request()->is('check-price*', 'widget/*')) ? 'active menu-open' : '' }}" style="height: auto;">
        ...
        <ul class="treeview-menu"
            ...
            <li class="{{ request()->is('check-price') ? 'active' : '' }}">
                <a href="{{route('admin.get-all-payment')}}"><i class="fa fa-send-o"></i>
                    <span>All bill</span></a>
            </li>
